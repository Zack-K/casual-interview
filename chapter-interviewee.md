...
　私は、それが嫌で仕方なかったため最近は”Calendly[^1]”というWebアプリケーションを利用し、こちらの空き日程を下記のような形で、先に全て共有することにしています。企業の日程調整担当者様には下記の中から自身の空いている日程で、私も空いている日を選ぶだけで私のカレンダーにもカジュアル面談の予定が設定されます。   
...
[^1]:https://calendly.com/ Googleアカウントがあれば、自身のGoogleカレンダーと連携して予定管理可能になるので便利です。
